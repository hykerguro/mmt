...
def get_me(force: bool = False) -> User:
    ...
    if force or me is None:
        me = _get_loop().run_until_complete(_client.get_me())
    return me
...
if __name__ == '__main__':
    ...
    _client.add_event_handler(message_dispatcher, events.NewMessage(incoming=True))
    _client.add_event_handler(callback_query_dispatcher, events.CallbackQuery())
